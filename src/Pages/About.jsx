...
const About = () => {
  const team = [
    { name: 'Priya Sharma', role: 'Head Instructor', emoji: '🧘‍♀️', exp: '10+ years' },
    { name: 'Rahul Verma', role: 'Meditation Coach', emoji: '🧘‍♂️', exp: '8+ years' },
    { name: 'Anita Singh', role: 'Hatha Yoga Expert', emoji: '🌸', exp: '6+ years' },
  ]

  const values = [
    { icon: '🌿', title: 'Natural Healing', desc: 'We believe in the power of nature and mindful movement to heal the body.' },
    { icon: '🤝', title: 'Community', desc: 'A warm, welcoming space for everyone regardless of age or skill level.' },
    { icon: '💪', title: 'Strength', desc: 'Build physical and mental strength through consistent practice.' },
    { icon: '☮️', title: 'Inner Peace', desc: 'Find balance and calm in your daily life through yoga and meditation.' },
  ]
  ...
  return (
    <div className="bg-white">
      ...
      <section className="max-w-7xl mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div className="bg-green-100 rounded-3xl h-80 flex items-center justify-center text-8xl shadow">
          🌱
        </div>
        <div>
          <span className="text-green-600 font-semibold text-sm uppercase tracking-widest">
